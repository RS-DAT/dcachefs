...
1. use the search functionality [here](https://github.com/RS-DAT/dcachefs/issues) to see if someone already filed the same issue;
...
1. install dependencies (see the [development section of the README](README.md#development));
...
1. Go to the [GitHub release page](https://github.com/RS-DAT/dcachefs/releases)
